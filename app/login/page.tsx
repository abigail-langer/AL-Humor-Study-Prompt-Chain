    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-gray-950">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">AL Humor Study</h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Prompt Chain Tool · Sign in to continue</p>
        </div>

        <div className="space-y-5 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          {errorMessage && (
